...
public class AddNewKYCPage extends PageBase {

    public By txtMyDocs = By.xpath("//h1[@class='ant-typography' and text()='My Documents']");
    public By EnterWalletNumbTxt = By.xpath("//h2[@class='ant-typography' and text()='Enter Wallet Number']");
    public By CreateKYCTxt = By.xpath("//h1[@class='ant-typography' and text()='Create KYC']");
    public By addressInformationTxt = By.xpath("//span[@class='ant-typography _formTitle_1ep99_1' and text()='Address Information']");
    ...
    public By additionalInfoTxt = By.xpath("//span[@class='ant-typography _formTitle_1ep99_1' and text()='Additional Information']");
    ...
    public AddNewKYCPage(WebDriver driver) {
        super(driver);
    }
    ...
    public String getEnterWalletNumbTitle() {
        String enterWalletNumTitle = getContent(EnterWalletNumbTxt);
        return enterWalletNumTitle;
    }

    public void clickAddKYCDocLink() {
        click(btnAddNewKYCDoc);
    }

    public String getMyDocsPageTitle() {
        String MyDocsPageTitle = getContent(txtMyDocs);
        return MyDocsPageTitle;
    }

    public void setMobileNumber() {
        setText(inputPhoneNumber, "01622446688");
    }
    ...
    public String getJobInfoTitle() {
        return getContent(jobInformationTxt);
    }
